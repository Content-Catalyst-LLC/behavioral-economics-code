#!/usr/bin/env Rscript
# Self-contained behavioral calculator for The Future of Behavioral Economics in Governance and Policy
...
result <- data.frame(
  ...
  article = "The Future of Behavioral Economics in Governance and Policy",
