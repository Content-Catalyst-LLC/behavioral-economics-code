...
rng = np.random.default_rng(14141)
...
for choice_id in range(1, n_choices + 1):
    immediate_reward = rng.uniform(50, 250, n_agents)
    delayed_reward = immediate_reward * rng.uniform(1.15, 2.20, n_agents)
    delay_periods = rng.integers(2, 18, n_agents)
    commitment_cost = rng.choice([0, 100, 300, 600], n_agents)
