#!/usr/bin/env Rscript
# Self-contained behavioral calculator for Behavioral Economics and AI-Driven Choice Architecture
...
result <- data.frame(
  ...
  article = "Behavioral Economics and AI-Driven Choice Architecture",
