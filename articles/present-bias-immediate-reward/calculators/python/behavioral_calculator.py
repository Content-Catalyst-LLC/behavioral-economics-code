#!/usr/bin/env python3
"""Self-contained behavioral calculator for Present Bias and the Psychology of Immediate Reward.
...
def main() -> None:
    ...
    result = {
        ...
        "article": 'Present Bias and the Psychology of Immediate Reward',
